...
export interface SeoRecord {
  ...
  /** ISO date the copy was last read end to end. */
  lastReviewed: string
  /** ISO date the prices on the page were last checked against invoices. */
...
export const SEO_REGISTRY: SeoRecord[] = [
  { path: '/', primaryKeyword: 'διαφημιστική εταιρεία άρτα', secondaryKeywords: ['διαφημιστικό γραφείο', 'διαφημιστική άρτα'], intent: 'brand', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/diafimistiki-eteria', primaryKeyword: 'διαφημιστική εταιρεία στην άρτα υπηρεσίες', secondaryKeywords: ['διαφημιστική ήπειρος'], intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/diafimistiki', primaryKeyword: 'τι κάνει μια διαφημιστική εταιρεία', intent: 'informational', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/services', primaryKeyword: 'υπηρεσίες adinfinity', intent: 'commercial', owner: 'manos', lastReviewed: REVIEWED },
  { path: '/grafistas-arta', primaryKeyword: 'γραφίστας άρτα', intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  ...
  { path: '/branding', primaryKeyword: 'branding άρτα', secondaryKeywords: ['σχεδιασμός λογοτύπου άρτα'], intent: 'commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/prints', primaryKeyword: 'εκτυπώσεις άρτα', secondaryKeywords: ['τυπογραφείο άρτα'], intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/ektypwseis-arta', primaryKeyword: 'ψηφιακές εκτυπώσεις μεγάλου μεγέθους άρτα', intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/epigrafes-arta', primaryKeyword: 'επιγραφές άρτα', secondaryKeywords: ['επιγραφές καταστημάτων', 'διαφημιστική πινακίδα'], intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/website-development', primaryKeyword: 'κατασκευή ιστοσελίδων άρτα', secondaryKeywords: ['κατασκευή web εφαρμογών'], intent: 'local-commercial', owner: 'konstantinos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  ...
  { path: '/website-development/e-commerce', primaryKeyword: 'κατασκευή e-shop', intent: 'commercial', owner: 'konstantinos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  ...
  { path: '/digital-marketing', primaryKeyword: 'digital marketing άρτα', intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/flyer-distribution', primaryKeyword: 'διανομή φυλλαδίων άρτα', secondaryKeywords: ['διανομή εντύπων'], intent: 'local-commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/diafimistika-dora', primaryKeyword: 'διαφημιστικά δώρα', secondaryKeywords: ['διαφημιστικά είδη'], intent: 'commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/market-research', primaryKeyword: 'έρευνα αγοράς', secondaryKeywords: ['μελέτη ανάλυσης ανταγωνισμού'], intent: 'commercial', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/invitations', primaryKeyword: 'ψηφιακό προσκλητήριο γάμου', intent: 'commercial', owner: 'konstantinos', lastReviewed: REVIEWED },
  { path: '/pricing', primaryKeyword: 'τιμοκατάλογος υπηρεσιών', secondaryKeywords: ['κόστος ιστοσελίδας', 'κόστος λογοτύπου'], intent: 'transactional', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
  { path: '/guides', primaryKeyword: 'οδηγοί κόστους διαφήμισης', intent: 'informational', owner: 'manos', lastReviewed: REVIEWED },
  { path: '/graphic-design-guide', primaryKeyword: 'οδηγός γραφιστικής', intent: 'informational', owner: 'manos', lastReviewed: REVIEWED, priceLastVerified: REVIEWED },
