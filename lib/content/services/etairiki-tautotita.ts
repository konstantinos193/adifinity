...
export const page: ContentPage = {
  ...
  summary: {
    el: 'Ένα σύστημα, όχι μόνο ένα σήμα: λογότυπο, χρώματα, τυπογραφία και οι κανόνες που κάνουν κάθε εφαρμογή να μοιάζει δική σας.',
    en: 'A system, not just a mark: logo, colours, typography and the rules that make every application look like yours.',
  },
  intro: [
    {
    ...
    },
    {
      ...
      en: 'The advantage shows a year later: whoever makes something for you, us or someone else, has rules to follow, and the business does not look like three different ones.',
    },
  ],
  sections: [
    {
      ...
      bullets: [
        { el: 'Λογότυπο με τρεις αρχικές προτάσεις, παραλλαγές και όλα τα διανυσματικά αρχεία', en: 'Logo with three initial concepts, variants and all vector files' },
        { el: 'Παλέτα χρωμάτων με κωδικούς CMYK για εκτύπωση, RGB και HEX για οθόνη', en: 'Colour palette with CMYK codes for print, RGB and HEX for screen' },
        { el: 'Τυπογραφία: γραμματοσειρές για τίτλους και κείμενο, με άδεια χρήσης', en: 'Typography: typefaces for headings and body text, with licence' },
        { el: 'Επαγγελματικές κάρτες και επιστολόχαρτο, έτοιμα για εκτύπωση', en: 'Business cards and letterhead, ready for print' },
        { el: 'Εικόνες προφίλ και εξωφύλλου για social media', en: 'Profile and cover images for social media' },
        { el: 'Brand guidelines: εγχειρίδιο σε PDF με τους κανόνες χρήσης, ελάχιστα μεγέθη, αποστάσεις, τι επιτρέπεται και τι όχι', en: 'Brand guidelines: a PDF manual with usage rules, minimum sizes, clear space, what is allowed and what is not' },
        { el: 'Τρεις γύροι αναθεωρήσεων', en: 'Three rounds of revisions' },
      ],
    },
    {
    ...
    {
      heading: { el: 'Από την ταυτότητα στην εφαρμογή', en: 'From identity to application' },
      paragraphs: [
        {
          el: 'Η ταυτότητα σχεδιάζεται από το ίδιο γραφείο που θα τυπώσει τις κάρτες, θα κατασκευάσει την επιγραφή και θα χτίσει την ιστοσελίδα. Αυτό σημαίνει ότι τα χρώματα επιλέγονται γνωρίζοντας πώς βγαίνουν σε ακρυλικό και σε χαρτί, και ότι δεν θα μεταφράζετε εσείς τους κανόνες σε τρεις προμηθευτές.',
          en: 'The identity is designed by the same office that will print the cards, fabricate the sign and build the website. That means colours are chosen knowing how they come out on acrylic and on paper, and you will not be translating the rules to three suppliers.',
        },
        {
          el: 'Παράδειγμα: για το Bohême Beach Bar στην Άρτα η ταυτότητα έπρεπε να δουλεύει σε μενού, επιγραφή στην παραλία, στολές προσωπικού και Instagram, με το ίδιο ύφος σε όλα.',
          en: 'Example: for Bohême Beach Bar in Arta the identity had to work on menus, a beach sign, staff uniforms and Instagram, with the same feel across all of them.',
        },
      ],
      link: { path: '/projects/boheme-beach-bar', label: { el: 'Δείτε το έργο Bohême', en: 'See the Bohême project' } },
    },
  ],
  faq: [
    {
      q: { el: 'Ποια η διαφορά λογοτύπου και εταιρικής ταυτότητας;', en: 'What is the difference between a logo and a corporate identity?' },
      a: {
        el: 'Το λογότυπο είναι το σήμα. Η ταυτότητα είναι το σήμα συν τα χρώματα, τις γραμματοσειρές, τις βασικές εφαρμογές και τους κανόνες χρήσης. Το λογότυπο αρκεί για μια επιγραφή και κάρτες. Η ταυτότητα χρειάζεται όταν θα εμφανίζεστε σε πολλά σημεία και θέλετε να μοιάζουν όλα δικά σας.',
        en: 'The logo is the mark. The identity is the mark plus the colours, typefaces, core applications and usage rules. A logo is enough for a sign and cards. An identity is needed when you appear in many places and want them all to look like yours.',
      },
    },
    {
    ...
    {
      q: { el: 'Τι είναι τα brand guidelines και γιατί τα χρειάζομαι;', en: 'What are brand guidelines and why do I need them?' },
      a: {
        el: 'Ένα PDF που δείχνει πώς χρησιμοποιείται το λογότυπο (ελάχιστο μέγεθος, αποστάσεις, φόντα), ποια χρώματα και γραμματοσειρές είναι δικές σας και τι απαγορεύεται. Το δίνετε σε όποιον φτιάχνει κάτι για εσάς, από τυπογράφο μέχρι κοινωνικά δίκτυα, και το αποτέλεσμα βγαίνει σωστό χωρίς να επιβλέπετε.',
        en: 'A PDF showing how the logo is used (minimum size, clear space, backgrounds), which colours and typefaces are yours, and what is not allowed. You give it to whoever makes something for you, from a printer to a social media manager, and the result comes out right without your supervision.',
      },
    },
    {
      q: { el: 'Πόσο διαρκεί;', en: 'How long does it take?' },
      a: {
        el: 'Η εταιρική ταυτότητα 2-4 εβδομάδες, το Premium 4-6, ανάλογα με τις εφαρμογές και τον ρυθμό των απαντήσεων στους γύρους.',
        en: 'Corporate identity 2-4 weeks, Premium 4-6, depending on the applications and how quickly rounds are answered.',
      },
    },
  ],
  ...
  breadcrumb: [
    ...
    { name: 'Εταιρική ταυτότητα', path: '/etairiki-tautotita' },
  ],
  service: {
