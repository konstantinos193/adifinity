...
export default function EktypwseisArtaPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Printer className="w-8 h-8" />,
      title: t('ektypwseis_arta_page.services.business_cards.title') as string,
      description: t('ektypwseis_arta_page.services.business_cards.description') as string,
    },
    {
      icon: <Package className="w-8 h-8" />,
      title: t('ektypwseis_arta_page.services.large_format.title') as string,
      description: t('ektypwseis_arta_page.services.large_format.description') as string,
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: t('ektypwseis_arta_page.services.premium.title') as string,
      description: t('ektypwseis_arta_page.services.premium.description') as string,
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: t('ektypwseis_arta_page.services.packaging.title') as string,
      description: t('ektypwseis_arta_page.services.packaging.description') as string,
    },
  ]

  const benefits = (t('ektypwseis_arta_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              {t('ektypwseis_arta_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ektypwseis_arta_page.hero.cta')}
              ...
              <Link href="/prints">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ektypwseis_arta_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('ektypwseis_arta_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('ektypwseis_arta_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('ektypwseis_arta_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('ektypwseis_arta_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ektypwseis_arta_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
