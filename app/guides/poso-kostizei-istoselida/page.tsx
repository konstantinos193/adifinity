...
import { page } from '@/lib/content/guides/poso-kostizei-istoselida'

// Everything on this route (metadata, JSON-LD, breadcrumbs, FAQ, proof) is
// derived from the content object. Edit lib/content/guides/poso-kostizei-istoselida.ts, not this file.
