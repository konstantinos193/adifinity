...
function PrintsPage() {
  ...
  const features = [
    ...
    },
    {
      ...
      description:
        "Διασφαλίζουμε έγκαιρη ολοκλήρωση κάθε έργου, χωρίς συμβιβασμούς στην ποιότητα.",
    },
    {
      ...
      >
        ...
        >
          <p className="text-lg text-center">
            Η σωστή εκτύπωση κάνει τη διαφορά! Είτε πρόκειται για διαφημιστικό
            υλικό, εταιρική επικοινωνία ή ειδικές εκτυπώσεις, η εταιρεία μας
            προσφέρει κορυφαία ποιότητα με σύγχρονες τεχνικές και υλικά.
          </p>
        </motion.div>
        ...
        <div className="mb-16">
          <div className="flex justify-center mb-8 gap-4 flex-wrap">
            {categories.map((category, index) => (
              <motion.button
                key={index}
                className={`px-6 py-3 rounded-full flex-1 max-w-[200px] mb-4 md:mb-0 ${
                  activeCategory === index
                    ? "bg-[#01FFFF] text-[#07141C]"
                    : "bg-[#0A1A24] text-[#01FFFF]"
                }`}
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="bg-[#0A1A24] p-8 rounded-lg h-auto overflow-y-auto">
              ...
              {/* Hide the IconComponent on mobile */}
              <div className="hidden md:flex bg-[#0A1A24] p-8 rounded-lg flex items-center justify-center h-[500px]">
