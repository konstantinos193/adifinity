...
export function ContactClient() {
  ...
  const schedule = [
    ...
    { day: t('contact.schedule.tuesday'), hours: ['09:00 - 14:30', '18:00 - 21:00'] },
    { day: t('contact.schedule.wednesday'), hours: ['09:00 - 14:30'] },
    { day: t('contact.schedule.thursday'), hours: ['09:00 - 14:30', '18:00 - 21:00'] },
    { day: t('contact.schedule.friday'), hours: ['09:00 - 14:30', '18:00 - 21:00'] },
    { day: t('contact.schedule.saturday'), hours: [t('contact.closed')] },
    { day: t('contact.schedule.sunday'), hours: [t('contact.closed')] }
  ]
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24] overflow-hidden">
      ...
      <div className="container mx-auto px-4 pb-20">
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-8 items-start">
          ...
          >
            <div id="contact-form">
              <h2 className="text-2xl font-bold mb-6 text-[#01FFFF]">{t('contact.form.title')}</h2>
              <ContactForm />
            </div>
          </motion.div>
          ...
          >
            ...
            >
              <h2 className="text-2xl font-bold mb-6 text-[#01FFFF]">{t('contact.contact_info')}</h2>
              ...
              <ul className="space-y-6">
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-white">{t('contact.address')}</h3>
                    <p className="text-gray-300 text-sm">{t('contact.contact_details.address_text')}</p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-white">{t('contact.phone')}</h3>
                    <p className="text-gray-300 text-sm">{t('contact.contact_details.phone_text')}</p>
                  </div>
                </li>
                ...
                <li className="flex items-start">
                  ...
                  <div>
                    <h3 className="font-medium text-white">{t('contact.email')}</h3>
                    <p className="text-gray-300 text-sm">{t('contact.contact_details.email_text')}</p>
                  </div>
                </li>
                      ...
                      {schedule.map((scheduleItem, index) => (
                        <div 
                          ...
                          className={`flex items-center justify-between p-2 rounded-lg transition-colors ${
                            scheduleItem.hours[0] === t('contact.closed') 
              ...
              <div className="mt-8 pt-6 border-t border-cyan-900/30">
                <h3 className="font-medium text-white mb-4">{t('contact.follow_us')}</h3>
                <div className="flex space-x-4">
                  <Link href={t('contact.social_links.facebook')} target="_blank" rel="noopener noreferrer">
                    <motion.div
                  ...
                  <Link href={t('contact.social_links.instagram')} target="_blank" rel="noopener noreferrer">
                    <motion.div
                      className="bg-[#071218] hover:bg-[#01FFFF]/10 border border-cyan-900/50 hover:border-[#01FFFF]/50 p-2 rounded-full transition-colors"
                      whileHover={{ y: -5 }}
                      transition={{ type: "spring", stiffness: 400, damping: 10 }}
                  ...
                  <Link
                    href={t('contact.social_links.linkedin')}
                    target="_blank"
