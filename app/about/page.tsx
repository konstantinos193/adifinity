    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      <section className="container mx-auto px-4">
        ...
        <div className="mb-16">
          ...
          <p className="text-lg mb-4 text-white">
          Η εταιρεία μας ιδρύθηκε το 2013 με στόχο να προσφέρει πρακτικές και αποτελεσματικές λύσεις μάρκετινγκ. Από τότε, βοηθάμε επιχειρήσεις να αναπτύξουν την παρουσία τους, προσαρμοζόμενοι στις εξελίξεις της αγοράς.          </p>
