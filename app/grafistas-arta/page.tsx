...
export default function GrafistasArtaPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Palette className="w-8 h-8" />,
      title: t('grafistas_arta_page.services.branding.title') as string,
      description: t('grafistas_arta_page.services.branding.description') as string,
    },
    {
      icon: <FileImage className="w-8 h-8" />,
      title: t('grafistas_arta_page.services.advertising.title') as string,
      description: t('grafistas_arta_page.services.advertising.description') as string,
    },
    {
      icon: <Monitor className="w-8 h-8" />,
      title: t('grafistas_arta_page.services.digital.title') as string,
      description: t('grafistas_arta_page.services.digital.description') as string,
    },
    {
      icon: <Layers className="w-8 h-8" />,
      title: t('grafistas_arta_page.services.specialized.title') as string,
      description: t('grafistas_arta_page.services.specialized.description') as string,
    },
  ]

  const benefits = (t('grafistas_arta_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              {t('grafistas_arta_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('grafistas_arta_page.hero.cta')}
              ...
              <Link href="/graphic-design">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('grafistas_arta_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('grafistas_arta_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('grafistas_arta_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('grafistas_arta_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('grafistas_arta_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('grafistas_arta_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
