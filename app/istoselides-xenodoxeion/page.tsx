...
import { page } from '@/lib/content/services/istoselides-xenodoxeion'

// Everything on this route (metadata, JSON-LD, breadcrumbs, FAQ, proof) is
// derived from the content object. Edit lib/content/services/istoselides-xenodoxeion.ts, not this file.
