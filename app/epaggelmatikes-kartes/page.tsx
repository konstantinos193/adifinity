...
import { page } from '@/lib/content/services/epaggelmatikes-kartes'

// Everything on this route (metadata, JSON-LD, breadcrumbs, FAQ, proof) is
// derived from the content object. Edit lib/content/services/epaggelmatikes-kartes.ts, not this file.
