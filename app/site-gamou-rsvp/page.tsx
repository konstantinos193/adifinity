...
import { ArrowRight, MapPin, Image, Calendar, Gift } from "lucide-react"
import Link from "next/link"
import { useTranslations } from "@/components/useTranslations"

export default function SiteGamouRsvpPage() {
  const { t } = useTranslations()

  const features = [
    {
      icon: <MapPin className="w-8 h-8" />,
      title: t('site_gamou_rsvp_page.features.map.title') as string,
      description: t('site_gamou_rsvp_page.features.map.description') as string,
    },
    {
      icon: <Image className="w-8 h-8" />,
      title: t('site_gamou_rsvp_page.features.gallery.title') as string,
      description: t('site_gamou_rsvp_page.features.gallery.description') as string,
    },
    {
      icon: <Calendar className="w-8 h-8" />,
      title: t('site_gamou_rsvp_page.features.timeline.title') as string,
      description: t('site_gamou_rsvp_page.features.timeline.description') as string,
    },
    {
      icon: <Gift className="w-8 h-8" />,
      title: t('site_gamou_rsvp_page.features.gifts.title') as string,
      description: t('site_gamou_rsvp_page.features.gifts.description') as string,
    },
  ]

  const benefits = (t('site_gamou_rsvp_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              {t('site_gamou_rsvp_page.hero.description')}
            </motion.p>
            ...
            >
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('site_gamou_rsvp_page.hero.cta')}
              ...
              <Link href="/invitations">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('site_gamou_rsvp_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('site_gamou_rsvp_page.features.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('site_gamou_rsvp_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('site_gamou_rsvp_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('site_gamou_rsvp_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('site_gamou_rsvp_page.cta.button')}
                </motion.button>
              </a>
            </div>
          </div>
