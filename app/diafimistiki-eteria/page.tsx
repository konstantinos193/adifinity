...
export default function DiafimistikiEteriaPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Users className="w-8 h-8" />,
      title: t('diafimistiki_eteria_page.services.team.title') as string,
      description: t('diafimistiki_eteria_page.services.team.description') as string,
    },
    {
      icon: <Award className="w-8 h-8" />,
      title: t('diafimistiki_eteria_page.services.portfolio.title') as string,
      description: t('diafimistiki_eteria_page.services.portfolio.description') as string,
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: t('diafimistiki_eteria_page.services.strategy.title') as string,
      description: t('diafimistiki_eteria_page.services.strategy.description') as string,
    },
    {
      icon: <CheckCircle className="w-8 h-8" />,
      title: t('diafimistiki_eteria_page.services.results.title') as string,
      description: t('diafimistiki_eteria_page.services.results.description') as string,
    },
  ]

  const benefits = (t('diafimistiki_eteria_page.benefits') as unknown) as Array<{ title: string; description: string }>

  const faqs = (t('diafimistiki_eteria_page.faq') as unknown) as Array<{ question: string; answer: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#01FFFF] text-sm font-medium">{t('diafimistiki_eteria_page.hero.badge')}</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('diafimistiki_eteria_page.hero.title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">
              {t('diafimistiki_eteria_page.hero.subtitle')}
            </h2>
            <motion.p
            ...
            >
              {t('diafimistiki_eteria_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistiki_eteria_page.hero.cta')}
              ...
              <Link href="/about">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistiki_eteria_page.hero.about_us')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistiki_eteria_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistiki_eteria_page.benefits_title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistiki_eteria_page.faq_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('diafimistiki_eteria_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('diafimistiki_eteria_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistiki_eteria_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
