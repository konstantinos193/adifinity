...
export default function DiafimistikiPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Megaphone className="w-8 h-8" />,
      title: t('diafimistiki_page.services.traditional.title') as string,
      description: t('diafimistiki_page.services.traditional.description') as string,
    },
    {
      icon: <Target className="w-8 h-8" />,
      title: t('diafimistiki_page.services.digital.title') as string,
      description: t('diafimistiki_page.services.digital.description') as string,
    },
    {
      icon: <TrendingUp className="w-8 h-8" />,
      title: t('diafimistiki_page.services.social.title') as string,
      description: t('diafimistiki_page.services.social.description') as string,
    },
    {
      icon: <BarChart className="w-8 h-8" />,
      title: t('diafimistiki_page.services.analytics.title') as string,
      description: t('diafimistiki_page.services.analytics.description') as string,
    },
  ]

  const benefits = (t('diafimistiki_page.benefits') as unknown) as Array<{ title: string; description: string }>

  const faqs = (t('diafimistiki_page.faq') as unknown) as Array<{ question: string; answer: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              {t('diafimistiki_page.hero.description')}
            </motion.p>
            ...
            >
              ...
              <Link href="/services">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistiki_page.hero.view_services')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistiki_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistiki_page.benefits_title')}
        </motion.h2>
            ...
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistiki_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
