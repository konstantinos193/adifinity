...
export default function GraphicDesignGuidePage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Palette className="w-8 h-8" />,
      title: t('graphic_design_guide_page.services.logo.title') as string,
      description: t('graphic_design_guide_page.services.logo.description') as string,
    },
    {
      icon: <Layout className="w-8 h-8" />,
      title: t('graphic_design_guide_page.services.branding.title') as string,
      description: t('graphic_design_guide_page.services.branding.description') as string,
    },
    {
      icon: <Type className="w-8 h-8" />,
      title: t('graphic_design_guide_page.services.print.title') as string,
      description: t('graphic_design_guide_page.services.print.description') as string,
    },
    {
      icon: <ImageIcon className="w-8 h-8" />,
      title: t('graphic_design_guide_page.services.digital.title') as string,
      description: t('graphic_design_guide_page.services.digital.description') as string,
    },
  ]

  const process = (t('graphic_design_guide_page.process') as unknown) as Array<{ step: string; title: string; description: string }>

  const faqs = (t('graphic_design_guide_page.faq') as unknown) as Array<{ question: string; answer: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#01FFFF] text-sm font-medium">{t('graphic_design_guide_page.hero.badge')}</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('graphic_design_guide_page.hero.title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">
              {t('graphic_design_guide_page.hero.subtitle')}
            </h2>
            <motion.p
            ...
            >
              {t('graphic_design_guide_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('graphic_design_guide_page.hero.cta')}
              ...
              <Link href="/graphic-design">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('graphic_design_guide_page.hero.view_services')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('graphic_design_guide_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('graphic_design_guide_page.process_title')}
        </motion.h2>
        ...
        >
          {process.map((item, index) => (
            <motion.div
              ...
              transition={{ duration: 0.3 }}
            >
              <div className="text-4xl font-bold text-[#01FFFF] mb-4">{item.step}</div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('graphic_design_guide_page.faq_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('graphic_design_guide_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('graphic_design_guide_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('graphic_design_guide_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
