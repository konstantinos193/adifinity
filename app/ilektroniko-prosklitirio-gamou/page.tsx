...
import { ArrowRight, Bell, Users, Download, Map } from "lucide-react"
  ...
  const features = [
    {
      ...
      title: t('ilektroniko_prosklitirio_gamou_page.features.notifications.title') as string,
      description: t('ilektroniko_prosklitirio_gamou_page.features.notifications.description') as string,
    },
    {
      icon: <Users className="w-8 h-8" />,
      title: t('ilektroniko_prosklitirio_gamou_page.features.guest_list.title') as string,
      description: t('ilektroniko_prosklitirio_gamou_page.features.guest_list.description') as string,
    },
    {
      icon: <Download className="w-8 h-8" />,
      title: t('ilektroniko_prosklitirio_gamou_page.features.export.title') as string,
      description: t('ilektroniko_prosklitirio_gamou_page.features.export.description') as string,
    },
    {
      icon: <Map className="w-8 h-8" />,
      title: t('ilektroniko_prosklitirio_gamou_page.features.map.title') as string,
      description: t('ilektroniko_prosklitirio_gamou_page.features.map.description') as string,
    },
  ]

  const benefits = (t('ilektroniko_prosklitirio_gamou_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#01FFFF] text-sm font-medium">{t('ilektroniko_prosklitirio_gamou_page.hero.badge')}</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('ilektroniko_prosklitirio_gamou_page.hero.title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">
              {t('ilektroniko_prosklitirio_gamou_page.hero.subtitle')}
            </h2>
            <motion.p
            ...
            >
              {t('ilektroniko_prosklitirio_gamou_page.hero.description')}
            </motion.p>
            ...
            >
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ilektroniko_prosklitirio_gamou_page.hero.cta')}
              ...
              <Link href="/invitations">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ilektroniko_prosklitirio_gamou_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('ilektroniko_prosklitirio_gamou_page.features.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('ilektroniko_prosklitirio_gamou_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('ilektroniko_prosklitirio_gamou_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('ilektroniko_prosklitirio_gamou_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('ilektroniko_prosklitirio_gamou_page.cta.button')}
                </motion.button>
              </a>
            </div>
          </div>
