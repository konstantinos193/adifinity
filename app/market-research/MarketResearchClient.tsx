  ...
  return (
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('market_research_page.hero_title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">{t('market_research_page.subtitle')}</h2>
            <motion.p
            ...
            >
              {t('market_research_page.hero_description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('market_research_page.request_quote')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4">
        ...
        >
          <h3 className="text-3xl font-bold mb-8 text-center text-[#01FFFF]">{t('market_research_page.services_title')}</h3>
        ...
        >
          <h3 className="text-3xl font-bold mb-8 text-center text-[#01FFFF]">{t('market_research_page.data_visualization_title')}</h3>
          <DataVisualization />
        </motion.div>
        ...
        >
          <h2 className="text-3xl font-bold mb-8 text-center text-[#01FFFF]">
