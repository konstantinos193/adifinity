...
import { ArrowRight, Video, Clock, Share2, Check } from "lucide-react"
import Link from "next/link"
import { useTranslations } from "@/components/useTranslations"

export default function PsifiakoProsklitirioGamouPage() {
  const { t } = useTranslations()

  const features = [
    {
      icon: <Video className="w-8 h-8" />,
      title: t('psifiako_prosklitirio_gamou_page.features.video.title') as string,
      description: t('psifiako_prosklitirio_gamou_page.features.video.description') as string,
    },
    {
      icon: <Clock className="w-8 h-8" />,
      title: t('psifiako_prosklitirio_gamou_page.features.countdown.title') as string,
      description: t('psifiako_prosklitirio_gamou_page.features.countdown.description') as string,
    },
    {
      icon: <Share2 className="w-8 h-8" />,
      title: t('psifiako_prosklitirio_gamou_page.features.sharing.title') as string,
      description: t('psifiako_prosklitirio_gamou_page.features.sharing.description') as string,
    },
    {
      icon: <Check className="w-8 h-8" />,
      title: t('psifiako_prosklitirio_gamou_page.features.rsvp.title') as string,
      description: t('psifiako_prosklitirio_gamou_page.features.rsvp.description') as string,
    },
  ]

  const benefits = (t('psifiako_prosklitirio_gamou_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#01FFFF] text-sm font-medium">{t('psifiako_prosklitirio_gamou_page.hero.badge')}</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('psifiako_prosklitirio_gamou_page.hero.title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">
              {t('psifiako_prosklitirio_gamou_page.hero.subtitle')}
            </h2>
            <motion.p
            ...
            >
              {t('psifiako_prosklitirio_gamou_page.hero.description')}
            </motion.p>
            ...
            >
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('psifiako_prosklitirio_gamou_page.hero.cta')}
              ...
              <Link href="/invitations">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('psifiako_prosklitirio_gamou_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('psifiako_prosklitirio_gamou_page.features.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('psifiako_prosklitirio_gamou_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('psifiako_prosklitirio_gamou_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('psifiako_prosklitirio_gamou_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <a href="https://invitations.adinfinity.gr" target="_blank" rel="noopener noreferrer">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('psifiako_prosklitirio_gamou_page.cta.button')}
                </motion.button>
              </a>
            </div>
          </div>
