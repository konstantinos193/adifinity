 ...
 */
import { COMPANY_FACTS, PRICES, euro } from "@/lib/company"
...
export const PRINTS_FAQ: FaqItem[] = [
  {
    ...
    a: `Οι τιμές εξαρτώνται από το είδος και την ποσότητα. Επαγγελματικές κάρτες από ${euro(PRICES.businessCardsPer100)} τα 100 τεμάχια, φυλλάδια από ${euro(PRICES.flyersPer500)} τα 500 τεμάχια, banner από ${euro(PRICES.bannerPerSqm)}/τμ². Πακέτα από ${euro(PRICES.printsSmall)} για έως 500 αντίτυπα. Στείλτε μας τι χρειάζεστε και λαμβάνετε ακριβή προσφορά.`,
  },
  {
...
export const GRAPHIC_DESIGN_FAQ: FaqItem[] = [
  {
    ...
    a: `Ο σχεδιασμός λογοτύπου ξεκινά από ${euro(PRICES.logo)}. Το βασικό πακέτο με λογότυπο και επαγγελματικές κάρτες από ${euro(PRICES.brandBasicPackage)}, και το πλήρες πακέτο εταιρικής ταυτότητας (χρώματα, γραμματοσειρές, brand guidelines) από ${euro(PRICES.brandIdentity)}.`,
  },
  {
...
export const FLYER_DISTRIBUTION_FAQ: FaqItem[] = [
  {
    ...
    a: `Η τοπική διανομή έως 1.000 φυλλαδίων σε μία ζώνη ξεκινά από ${euro(PRICES.distributionLocal)}. Για 1.000-5.000 φυλλάδια σε έως τρεις ζώνες από ${euro(PRICES.distributionExtended)}, και για κάλυψη ολόκληρης της πόλης και της περιφέρειας από ${euro(PRICES.distributionRegional)}. Η εκτύπωση κοστολογείται ξεχωριστά ή μαζί, όπως προτιμάτε.`,
  },
  {
...
export const GUIDE_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: `Το κόστος εξαρτάται από το εύρος του έργου. Ο σχεδιασμός λογοτύπου ξεκινά από ${euro(PRICES.logo)}, ενώ ένα ολοκληρωμένο πακέτο εταιρικής ταυτότητας από ${euro(PRICES.brandIdentity)}.`,
  },
  {
    q: 'Ποια αρχεία παραλαμβάνω;',
...
export const WEBDEV_FAQ: FaqItem[] = [
  ...
  },
  {
    ...
    a: `Μια επαγγελματική ιστοσελίδα ξεκινά από ${euro(PRICES.websiteStarter)} και μια πλήρης εταιρική παρουσία με admin panel από ${euro(PRICES.websiteBusiness)}. Ένα custom e-shop ξεκινά από ${euro(PRICES.eshop)}. Οι web εφαρμογές κοστολογούνται ανάλογα με τις λειτουργίες. Ζητήστε δωρεάν προσφορά για ακριβή εκτίμηση.`,
  },
  {
