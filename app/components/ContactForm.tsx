        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
          ...
          <div>
            ...
            >
              ...
              <option value="Γενική Πληροφορία">{t('contact.form.subject_options.general_info')}</option>
              <option value="Προσφορά">{t('contact.form.subject_options.request_quote')}</option>
              <option value="Συνεργασία">{t('contact.form.subject_options.partnership')}</option>
              <option value="Άλλο">{t('contact.form.subject_options.other')}</option>
            </select>
          </div>
        </div>
            ...
            <div className="text-center">
              ...
              {formData.file && (
                <p className="mt-2 text-sm text-[#01FFFF]">
                  {t('contact.form.selected_file')}: {formData.file.name}
                </p>
              )}
            </div>
          </div>
