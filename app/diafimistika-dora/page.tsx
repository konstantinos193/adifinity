...
export default function DiafimistikaDoraPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <PenTool className="w-8 h-8" />,
      title: t('diafimistika_dora_page.services.stationery.title') as string,
      description: t('diafimistika_dora_page.services.stationery.description') as string,
    },
    {
      icon: <Coffee className="w-8 h-8" />,
      title: t('diafimistika_dora_page.services.drinkware.title') as string,
      description: t('diafimistika_dora_page.services.drinkware.description') as string,
    },
    {
      icon: <Shirt className="w-8 h-8" />,
      title: t('diafimistika_dora_page.services.apparel.title') as string,
      description: t('diafimistika_dora_page.services.apparel.description') as string,
    },
    {
      icon: <ShoppingBag className="w-8 h-8" />,
      title: t('diafimistika_dora_page.services.bags.title') as string,
      description: t('diafimistika_dora_page.services.bags.description') as string,
    },
  ]

  const benefits = (t('diafimistika_dora_page.benefits') as unknown) as Array<{ title: string; description: string }>

  const faqs = (t('diafimistika_dora_page.faq') as unknown) as Array<{ question: string; answer: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
      ...
      <div className="relative">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              {t('diafimistika_dora_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistika_dora_page.hero.cta')}
              ...
              <Link href="/prints">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistika_dora_page.hero.view_catalog')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistika_dora_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistika_dora_page.benefits_title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('diafimistika_dora_page.faq_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('diafimistika_dora_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('diafimistika_dora_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('diafimistika_dora_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
