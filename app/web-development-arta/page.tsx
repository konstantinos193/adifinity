...
export default function WebDevelopmentArtaPage() {
  const { t } = useTranslations()

  const services = [
    {
      icon: <Code className="w-8 h-8" />,
      title: t('web_development_arta_page.services.custom_websites.title') as string,
      description: t('web_development_arta_page.services.custom_websites.description') as string,
    },
    {
      icon: <Smartphone className="w-8 h-8" />,
      title: t('web_development_arta_page.services.web_apps.title') as string,
      description: t('web_development_arta_page.services.web_apps.description') as string,
    },
    {
      icon: <Zap className="w-8 h-8" />,
      title: t('web_development_arta_page.services.e_commerce.title') as string,
      description: t('web_development_arta_page.services.e_commerce.description') as string,
    },
    {
      icon: <Shield className="w-8 h-8" />,
      title: t('web_development_arta_page.services.seo.title') as string,
      description: t('web_development_arta_page.services.seo.description') as string,
    },
  ]

  const benefits = (t('web_development_arta_page.benefits') as unknown) as Array<{ title: string; description: string }>
    ...
    <main className="min-h-screen py-20 bg-gradient-to-b from-[#07141C] to-[#0A1A24]">
        ...
        <div className="container mx-auto px-4 pt-28 pb-20 relative z-10">
          ...
          >
            ...
            >
              ...
              <span className="text-[#01FFFF] text-sm font-medium">{t('web_development_arta_page.hero.badge')}</span>
            </motion.div>

            <h1 className="text-5xl md:text-7xl mb-4 font-bold bg-clip-text text-transparent bg-gradient-to-r from-[#01FFFF] to-[#01A9FF]">
              {t('web_development_arta_page.hero.title')}
            </h1>
            <h2 className="text-xl md:text-2xl mb-8 text-[#01FFFF]">
              {t('web_development_arta_page.hero.subtitle')}
            </h2>
            <motion.p
            ...
            >
              {t('web_development_arta_page.hero.description')}
            </motion.p>
            ...
            >
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('web_development_arta_page.hero.cta')}
              ...
              <Link href="/website-development">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('web_development_arta_page.hero.learn_more')}
                </motion.button>
              </Link>
            </motion.div>
          </motion.div>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('web_development_arta_page.services.title')}
        </motion.h2>
      ...
      <div className="container mx-auto px-4 py-16">
        <motion.h2
          ...
          transition={{ duration: 0.8 }}
        >
          {t('web_development_arta_page.benefits_title')}
        </motion.h2>
        ...
        >
          ...
          <div className="relative z-10">
            <h3 className="text-3xl md:text-4xl font-bold mb-6 text-center text-white">
              {t('web_development_arta_page.cta.title')}
            </h3>
            <p className="text-lg text-center max-w-3xl mx-auto mb-8 text-gray-300">
              {t('web_development_arta_page.cta.description')}
            </p>
            <div className="flex flex-col sm:flex-row justify-center gap-4">
              <Link href="/contact#contact-form">
                <motion.button
                  ...
                  whileTap={{ scale: 0.95 }}
                >
                  {t('web_development_arta_page.cta.button')}
                </motion.button>
              </Link>
            </div>
          </div>
